...
public class VanishMethodes
{
    ...
    public final static ArrayList<Player> vanishedplayers = new ArrayList<Player>();
    ...
    public void restartvanishcheck()
    {
        ...
        {
            if (VanishMethodes.vanishedplayers.contains(onlineplayers))
            {
                VanishMethodes.vanishedplayers.remove(onlineplayers);
